...
class ModelBase(ABC):
    ...
    def generate_completions(
        ...
        optional_fields = [
            ...
            "language_id",
            "prompt_id",
        ]  # multilingual datasets have these, but monolingual one not (except for category)
        present_fields = (
            [f for f in optional_fields if f in dataset[0]] if dataset else []
        )
