# copied from https://github.com/andyrdt/refusal_direction/blob/main/pipeline/model_utils/gemma_model.py, but originally was not contained in the repository.
import torch
import functools
